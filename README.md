...
![](https://github.com/ashok711/aws-ecs-terraform)
...
1. `git clone https://github.com/ashok711/aws-ecs-terraform.git`
...
In file `ecs.tf` we create:
  ...
  - task definition with family _web-family_, volume and container definition is defined in the file container-def.json.tpl
